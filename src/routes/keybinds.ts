...
export function onkeydown(e: KeyboardEvent)
{
  ...
  keybind: {
    switch (e.key.toUpperCase()) {
        case "Q": synth.start(Note.A_FLAT,  synth.octave - 1); break keybind;
      case "A":   synth.start(Note.A,       synth.octave - 1); break keybind;
        case "W": synth.start(Note.B_FLAT,  synth.octave - 1); break keybind;
      case "S":   synth.start(Note.B,       synth.octave - 1); break keybind;
      ...
      case "K":   synth.start(Note.A,       synth.octave); break keybind;
        case "O": synth.start(Note.B_FLAT,  synth.octave); break keybind;
      case "L":   synth.start(Note.B,       synth.octave); break keybind;
...
export function onkeyup(e: KeyboardEvent)
{
  ...
  keybind: {
    switch (e.key.toUpperCase()) {
        case "Q": synth.stop(Note.A_FLAT,  synth.octave - 1); break keybind;
      case "A":   synth.stop(Note.A,       synth.octave - 1); break keybind;
        case "W": synth.stop(Note.B_FLAT,  synth.octave - 1); break keybind;
      case "S":   synth.stop(Note.B,       synth.octave - 1); break keybind;
      ...
      case "K":   synth.stop(Note.A,       synth.octave); break keybind;
        case "O": synth.stop(Note.B_FLAT,  synth.octave); break keybind;
      case "L":   synth.stop(Note.B,       synth.octave); break keybind;
      case ";":   synth.stop(Note.C,       synth.octave + 1); break keybind;
        case "[": synth.stop(Note.C_SHARP, synth.octave + 1); break keybind;
        case "'": synth.stop(Note.D,       synth.octave + 1); break keybind;
        case "]": synth.stop(Note.E_FLAT,  synth.octave + 1); break keybind;
      default: return;
    }
  }
